...
function preload(){
  ...
  mi = loadAnimation("monkey_0.png","monkey_1.png","monkey_2.png","monkey_3.png","monkey_4.png","monkey_5.png","monkey_6.png","monkey_7.png","monkey_8.png");
...
function setup() {
 createCanvas(600,500);
  ...
  girl.addImage("girl",gi);
  girl.scale=0.4;


  
  ape=createSprite(50,410,20,30);
  ape.addAnimation("ape",mi);
  ape.scale=0.2;
